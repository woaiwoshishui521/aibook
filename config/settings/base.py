"""
Django base settings for aibook project.
"""
import environ
...
# DEBUG and ALLOWED_HOSTS - can be overridden in environment-specific settings
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'AIBook API',
    'DESCRIPTION': 'API documentation for AIBook project',
    'VERSION': '1.0.0',
...
CELERY_BROKER_URL = env('CELERY_BROKER_URL', default='redis://:yungee@yungee.cn:6379/0')
CELERY_RESULT_BACKEND = env('CELERY_RESULT_BACKEND', default='redis://:yungee@yungee.cn:6379/0')
